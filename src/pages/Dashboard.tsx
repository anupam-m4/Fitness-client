...
const Dashboard = () => {
  ...
  return (
    <div className="page-container">
      ...
      <div className="dashboard-header bg-gradient-to-r from-indigo-600 to-pink-500 rounded-2xl p-6 shadow-xl">
        <div className="flex justify-between items-start">
          <div>
            <p className="text-indigo-100 text-sm font-medium">Welcome back</p>
            <h1 className="text-2xl font-bold mt-1 text-white">{`Hi there! 👋 ${user?.username}`}</h1>
          </div>
          <button
            onClick={toggleTheme}
